...
This pad will be locked after your allotted time has run out. 
...
class Kadane {
  ...
  public static void main(String[] args) {
    ...
    // Test case 4
    int[] array4 = {-1, 2, -3, 4, 0, -101, 102, 11, 99, 111, -111, 112, -99, 99};
    ...
    int[] array9 = {Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE};
    printMaxSumSubArray(array9);
    
    // Test case 10: All Integer.MAX_VALUE
    int[] array10 = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE};
    printMaxSumSubArray(array10);
    
    // Test case 11: All Integer.MIN_VALUE with -1
    int[] array11 = {Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, -1};
